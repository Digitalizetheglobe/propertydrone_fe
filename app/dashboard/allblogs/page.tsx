...
export default function AllBlogs() {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await axios.get("http://api.propertydronerealty.com/blogs");
  ...
  const handleDelete = async (id: number) => {
    try {
      await axios.delete(`http://api.propertydronerealty.com/blogs/${id}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(`http://api.propertydronerealty.com/blogs/${editBlog.id}`, editBlog);
