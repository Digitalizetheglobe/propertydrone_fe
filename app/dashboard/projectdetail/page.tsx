...
export default function ProjectDetail() {
  ...
  const fetchProjects = () => {
    fetch("api.propertydronerealty.com/projects")
      .then((res) => res.json())
      .then((data) => {
        setProjects(data);
        setLoading(false);
  ...
  const handleDelete = async (id: string) => {
    if (window.confirm("Are you sure you want to delete this project?")) {
      try {
        const response = await fetch(`api.propertydronerealty.com/projects/${id}`, {
          method: "DELETE",
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`api.propertydronerealty.com/projects/${currentProject.id}`, {
        method: "PUT",
        headers: {
