...
export default function AllNews() {
    ...
    const fetchNews = async () => {
        try {
            const response = await axios.get("http://api.propertydronerealty.com/news");
    ...
    const handleDelete = async (id: number) => {
        try {
            await axios.delete(`http://api.propertydronerealty.com/news/${id}`);
    ...
    const handleUpdate = async () => {
        ...
        try {
            await axios.put(`http://api.propertydronerealty.com/news/${editNews.id}`, editNews);
