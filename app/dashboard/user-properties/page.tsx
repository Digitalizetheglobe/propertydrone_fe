...
export default function UserSubmittedProperties() {
    ...
    const fetchProperties = async () => {
        try {
            const response = await axios.get("http://api.propertydronerealty.com/api/user-properties");
    ...
    const handleStatusUpdate = async (id: number, newStatus: string) => {
        try {
            await axios.put(`http://api.propertydronerealty.com/api/user-properties/${id}`, { status: newStatus });
            fetchProperties();
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            await axios.delete(`http://api.propertydronerealty.com/api/user-properties/${id}`);
