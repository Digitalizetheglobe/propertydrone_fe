                ...
                >
                  ...
                  <a href="tel:+919561477575" className="flex  hover:underline">
                    <div className="flex justify-start items-start w-10">
                      <Image src={mob} alt="Phone icon" className="h-5 w-5" />
                    </div>
                    <span
                  ...
                  <a href="tel:+919156123575" className="flex  hover:underline">
                    <div className="flex justify-start items-start w-10">
                      <Image src={mob} alt="Phone icon" className="h-5 w-5" />
                    </div>
                    <span
                  ...
                  >
                    <div className="flex justify-start items-start w-10">
                      <Image src={mail} alt="Phone icon" className="h-5 w-5" />
                    </div>
                    <span
                      className=" text-base leading-none"
                      style={{ fontFamily: "Lato", letterSpacing: "0.5px" }}
    ...
    >
      ...
      Maharashtra, 411045
              ...
              <div className="mt-2 md:ml-20">
                <h3 className="text-sm font-semibold mb-6 text-white tracking-wide">
                  Quick Links
                </h3>
                <ul
                ...
                >
                  ...
                  <li>
                    <Link
                      ...
                      className="hover:text-white transition-colors"
                    >
                      Top Projects by Majestique Developer
                    </Link>
                  </li>
                  <li>
                    <Link
                  ...
                  <li>
                    <Link
                      ...
                      className="hover:text-white transition-colors"
                    >
                      Top Projects by Skyi Developers
                    </Link>
                  </li>
                  <li>
                    <Link
