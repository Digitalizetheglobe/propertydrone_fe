            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-12 flex flex-col lg:flex-row gap-12 items-center">
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <button className="px-8 py-3 border border-[#FF3B30] text-[#FF3B30] rounded hover:bg-red-50 transition-colors duration-300 font-medium whitespace-nowrap">
                            Enquire Now
                        </button>
                        <button className="px-8 py-3 bg-[#25D366] text-white rounded hover:bg-[#20bd5a] transition-colors duration-300 font-medium flex items-center justify-center gap-2 whitespace-nowrap">
