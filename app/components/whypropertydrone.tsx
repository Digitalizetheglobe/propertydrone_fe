...
export default function WhyPropertyDrone() {
    return (
        <>
            <div className="">
                <div className="max-w-6xl mx-auto py-16 px-4">
                    ...
                    <div className="flex flex-col sm:flex-row mb-[25px] w-full justify-between items-start gap-6 sm:gap-0">
                        <div className="w-full sm:w-1/2 pr-4">
                            <h2 className="text-xl sm:text-2xl lg:text-4xl font-bold text-[#172747] uppercase tracking-wider mb-2" style={{ fontFamily: 'Lato, sans-serif' }}>
                                Why Property Drone?
                            </h2>
                            <h3 className="text-xl sm:text-2xl lg:text-4xl font-[300] text-[#172747]" style={{ fontFamily: 'Ivy Mode, sans-serif' }}>
                                Built on trust. Designed for ease.
                            </h3>
                        </div>
                        <p className="w-full sm:w-1/2 text-lg text-[#172747] opacity-80" style={{ fontFamily: 'Lato, sans-serif' }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 ease-out group cursor-pointer">
                            <div className="p-8">
                                ...
                                <h3 className="text-[#172747] text-lg font-semibold mb-3 group-hover:text-[#172747]" style={{ fontFamily: 'Lato, sans-serif' }}>
                                    Verified Listings
                                </h3>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 ease-out group cursor-pointer">
                            <div className="p-8">
                                ...
                                <h3 className="text-[#172747] text-lg font-semibold mb-3 group-hover:text-[#172747]" style={{ fontFamily: 'Lato, sans-serif' }}>Expert Assistance</h3>
                                <p className="text-[#172747] text-sm font-medium leading-relaxed opacity-70 group-hover:opacity-100 transition-opacity">
