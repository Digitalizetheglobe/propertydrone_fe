...
export default function LuxePropertyDetail({ property }: PropertyDetailProps) {
  ...
  const generateQRCode: GenerateQRCodeFn = (text) => {
    const size = "200x200";
    const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=${size}&data=${encodeURIComponent(
      text
    )}`;
    setQrCodeUrl(qrUrl);
  };
  ...
  const propertyDetails = {
    beds: property.topology?.includes("BHK")
      ? property.topology.charAt(0)
      : "4",
    baths: property.topology?.includes("BHK")
      ? Math.max(1, parseInt(property.topology.charAt(0)) - 1)
      : "3",
    area: property.carpetArea || "2500 sq ft",
    year: property.createdAt
      ? new Date(property.createdAt).getFullYear().toString()
      : "2022",
    heating: "Central",
    cooling: "Central AC",
    parking: "2 Garage",
            ...
            <Head>
              ...
              <meta
                ...
                content={
                  ...
                  `Luxury property listing for ${property.propertyName}`
                }
              />
          ...
          <div className="max-w-6xl pb-6 mx-auto flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2 bg-white rounded-lg p-6 shadow-md">
              ...
              <h2 className="text-xl font-bold mb-4">
                {property.topology || "LUXURY RESIDENCE"}
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#172747] rounded-lg shadow-md p-6 mb-8 text-white">
                <h2 className="text-white mb-6 font-[300] text-[32px] leading-[140%] tracking-[1px] font-[Ivy Mode] mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="bg-[#172747] text-white p-6 text-center">
                <h1 className="text-2xl font-bold">
                  {" "}
                  {property.propertyName} QR Codes
                </h1>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <h4 className="font-medium text-[#172747] mb-2">
                        How to Use:
                      </h4>
...
export async function getServerSideProps(context: {
  ...
  try {
    const res = await fetch(
      `api.propertydronerealty.com/properties/${slug}`
    );
    if (!res.ok) {
