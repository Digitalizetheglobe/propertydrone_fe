...
import propertydetails1 from '../../public/images/bgimage1.png';
export default function PrivacyPolicy() {
  return (
    ...
    <div className="text-center max-w-3xl mx-auto text-[#172747]">
      ...
      <h2
        className="text-[#172747] mb-6 font-[400] text-[48px] leading-[140%] tracking-[1px] font-[Ivy Mode] max-sm:text-[36px]"
        style={{
          fontFamily: 'Ivy Mode',
          fontSize: '48px',
          letterSpacing: '1px'
      ...
      >
        Your privacy is important to us. At PropertyDrone Realty, we ensure your
          ...
          <div className="bg-white shadow-md rounded-lg p-6 md:p-8">
            <div className="prose max-w-none">
              ...
              <p className="text-gray-700">
                For questions, contact <a href="mailto:info@propertydronerealty.com" className="text-blue-600 hover:text-blue-800 hover:underline">info@propertydronerealty.com</a> or call <a href="tel:+919730156575" className="text-blue-600 hover:text-blue-800 hover:underline">+91 9730156575</a>.
              </p>
            </div>
          </div>
