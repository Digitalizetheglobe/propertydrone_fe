  ...
  <div className="relative z-10 flex items-center justify-center min-h-screen px-4 bg-gradient-to-br text-white">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto items-center">
      ...
      >
        ...
        >
          Solitaire is a melting pot of a multitude of facets. We are contemporary, progressive, and innovative. But most importantly, we are a chip off the Chordia legacy. With over 30+ years of development experience, more than 40 completed projects and sustained growth to become one of the largest enterprises in Pune city.
        </p>
        <p
          className="text-gray-300 max-w-3xl text-base leading-none mb-4"
          style={{ fontFamily: 'Lato', letterSpacing: '1px', lineHeight: '1.5' }}
